...
#	dataset by taking help from 1-mnist-with-keras.ipynb 
#	available at:
...
#	========================================================
trnLblSet  = tf.keras.utils.to_categorical(trnLblSet, CLASS_NO)
tstLblSet = tf.keras.utils.to_categorical(tstLblSet, CLASS_NO)
